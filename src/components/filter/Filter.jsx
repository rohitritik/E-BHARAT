...
function Filter() {
    ...
    const handleSearchChange = (e) => {
        ...
        filterProducts(e.target.value, filterType, filterPrice);
    }

    const handleFilterTypeChange = (e) => {
        setFilterType(e.target.value);
        filterProducts(searchkey, e.target.value, filterPrice);
    }

    const handleFilterPriceChange = (e) => {
        setFilterPrice(e.target.value);
        filterProducts(searchkey, e.target.value, filterType);
    }
    ...
    const resetFilters = () => {
        ...
        setFilterType('');
        setFilterPrice('');
        setFilteredProduct(originalProducts);
    }

    const filterProducts = (searchKey, type, price) => {
